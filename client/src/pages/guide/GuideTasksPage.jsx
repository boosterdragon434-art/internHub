...
/**
 * GuideTasksPage Component — Comprehensive dashboard for task creation, planning, and student tracking.
 */
        ...
        <div className="border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden bg-white dark:bg-slate-950/20">
          <div className="overflow-x-auto">
            ...
            {filteredTasks.length === 0 && (
              <div className="text-center py-20 text-slate-500">No tasks match selected filter criteria.</div>
            )}
          </div>
        </div>
      )}
            ...
            >
              ...
              <div className="flex justify-end gap-3 pt-3 border-t border-slate-200 dark:border-slate-850">
                <button
                  type="button"
                  onClick={() => setIsCreateModalOpen(false)}
                  className="px-4 py-2 border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-550 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200 rounded-xl text-sm font-semibold transition"
                >
                  Cancel
                </button>
                <button
